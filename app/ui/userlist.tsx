...
const users = [
    ...
    // 10 new users with mechanical and civil engineering backgrounds
    {
      ...
      office: "Mexico City",
      onboarded: true,
      expertise: ["HVAC Systems", "Industrial Ventilation", "Mechanical Design", "AutoCAD"],
      projects: ["Factory Ventilation Upgrade", "Energy Efficiency Project", "Production Line Redesign"],
      experience: [
        { company: "Heller Industries", role: "Mechanical Engineer", period: "2020-Present" },
        { company: "Grupo Bimbo", role: "Maintenance Engineer", period: "2017-2020" },
      ],
      managerNotes:
    ...
    },
    {
      ...
      office: "Taipei",
      onboarded: true,
      expertise: ["Structural Analysis", "Seismic Design", "Building Codes", "Steel Structures"],
      projects: ["Factory Expansion Project", "Equipment Foundation Design", "Seismic Retrofit"],
      experience: [
        { company: "Heller Industries", role: "Structural Engineer", period: "2019-Present" },
        { company: "Taiwan Construction Corp", role: "Junior Engineer", period: "2016-2019" },
      ],
      managerNotes:
    ...
    },
    {
      ...
      office: "Dubai",
      onboarded: true,
      expertise: ["Construction Management", "Site Planning", "Quality Control", "Infrastructure Development"],
      projects: ["Dubai Facility Construction", "Clean Room Implementation", "Infrastructure Upgrade"],
      experience: [
        { company: "Heller Industries", role: "Civil Engineer", period: "2018-Present" },
        { company: "Emaar Properties", role: "Project Engineer", period: "2015-2018" },
      ],
      managerNotes:
    ...
    },
    {
      ...
      office: "Manchester",
      onboarded: true,
      expertise: ["3D Modeling", "Product Design", "Thermal Analysis", "Prototyping"],
      projects: ["Next-Gen Conveyor System", "Cooling System Redesign", "Modular Equipment Platform"],
      experience: [
        { company: "Heller Industries", role: "Mechanical Design Engineer", period: "2021-Present" },
    ...
    },
    {
      ...
      office: "Osaka",
      onboarded: true,
      expertise: ["Lean Manufacturing", "Process Automation", "Quality Systems", "Kaizen"],
      projects: ["Production Line Automation", "Quality Improvement Initiative", "Lean Implementation"],
      experience: [
        { company: "Heller Industries", role: "Manufacturing Engineer", period: "2019-Present" },
        { company: "Toyota Motor Corporation", role: "Process Engineer", period: "2015-2019" },
      ],
      managerNotes:
    ...
    },
    {
      ...
      office: "São Paulo",
      onboarded: false,
      expertise: ["Project Management", "Construction Supervision", "Budget Control", "Regulatory Compliance"],
      projects: ["Brazil Manufacturing Facility", "Sustainable Building Initiative", "Site Expansion"],
      experience: [
        { company: "Heller Industries", role: "Civil Project Manager", period: "2023-Present" },
    ...
    },
    {
      ...
      office: "Moscow",
      onboarded: true,
      expertise: ["Hydraulic Systems", "Pneumatics", "Industrial Automation", "Fluid Dynamics"],
      projects: ["Automated Material Handling", "Hydraulic Press Redesign", "Energy Recovery System"],
      experience: [
        { company: "Heller Industries", role: "Mechanical Systems Engineer", period: "2020-Present" },
    ...
    },
    {
      ...
      office: "Mumbai",
      onboarded: true,
      expertise: ["Structural Engineering", "FEA Analysis", "Construction Materials", "Industrial Structures"],
      projects: ["Mumbai Facility Expansion", "Heavy Equipment Foundations", "Vibration Analysis"],
      experience: [
        { company: "Heller Industries", role: "Structural Design Engineer", period: "2019-Present" },
        { company: "Larsen & Toubro", role: "Design Engineer", period: "2016-2019" },
      ],
      managerNotes:
    ...
    },
    {
      ...
      office: "Stockholm",
      onboarded: true,
      expertise: ["Facility Management", "Sustainable Design", "Energy Systems", "Building Automation"],
      projects: ["Green Building Certification", "Energy Monitoring System", "Facility Modernization"],
      experience: [
        { company: "Heller Industries", role: "Facilities Engineer", period: "2018-Present" },
    ...
    },
    {
      ...
      office: "Riyadh",
      onboarded: false,
      expertise: ["Infrastructure Planning", "Water Systems", "Desert Construction", "Sustainability"],
      projects: ["Riyadh Facility Water Systems", "Sustainable Cooling Solutions", "Desert-Adapted Design"],
      experience: [
        { company: "Heller Industries", role: "Civil Infrastructure Engineer", period: "2022-Present" },
        { company: "Saudi Aramco", role: "Infrastructure Engineer", period: "2018-2022" },
      ],
      managerNotes:
        ...
        {filteredUsers.map((user) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <div className="text-[#0083BF] font-medium text-sm">{t("view.profile")}</div>
            </div>
          </div>
        ))}
      </div>
